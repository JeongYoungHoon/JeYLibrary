...
package com.jey_dev.lib.dialog.view;
...
public class JColorPickerView extends View {
    ...
    public JColorPickerView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        ctx= context;
        init();
    }

    public JColorPickerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        ctx= context;
        init();
    }

    public JColorPickerView(Context context) {
        super(context);
        ctx= context;
        init();
    }
