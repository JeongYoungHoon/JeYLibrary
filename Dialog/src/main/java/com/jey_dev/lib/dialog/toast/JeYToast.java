...
class JeYToast extends Toast {
    ...
    public static final int TYPE_PRIMARY_DARK = 7;
    ...
    private View getViews(int type, String msg) {
        ...
        switch (type) {
            ...
            case TYPE_BLACK_TR:
                ...
                break;
            case TYPE_PRIMARY:
                backColor = mContext.getResources().getColor(R.color.colorPrimary);
                textColor = COLOR_WHITE;
                break;
            case TYPE_PRIMARY_DARK:
                backColor = mContext.getResources().getColor(R.color.colorPrimaryDark);
                textColor = COLOR_WHITE;
                break;
        }
