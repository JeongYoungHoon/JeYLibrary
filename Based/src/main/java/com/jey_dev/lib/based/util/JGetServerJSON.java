 ...
 */
public class JGetServerJSON extends AsyncTask<String, Void, Message> {
...
//                    sendCheckHandler(OnCheckHandler.HAS_NOT, null);
    ...
    protected JGetServerJSON() {
    }

    public JGetServerJSON(String url, OnCommuListener checkHandler) {
        this(url, checkHandler, false);
    }

    public JGetServerJSON(String url, OnCommuListener checkHandler, boolean isPost) {
        this.checkHandler = checkHandler;
        this.url = url;
        this.isPost = isPost;
    }

    public JGetServerJSON(String url, OnCommuListener checkHandler, JSONObject obj) {
        this(url, checkHandler);
        setParam(obj);
    }

    public JGetServerJSON(String url, OnCommuListener checkHandler, JSONObject obj, boolean isPost) {
        this(url, checkHandler, isPost);
        setParam(obj);
    }

    public JGetServerJSON setParam(JSONObject obj) {
...
//        Log.d("Test,CommuServer",$value);
    ...
    public JGetServerJSON addParam(String key, String value) {
        if (isPost)
    ...
    public JGetServerJSON addParam(String key, boolean value) {
        if (isPost)
            this.params = this.params + "&" + key + "=" + value;
        else
            this.url = this.url + "&" + key + "=" + value;
    ...
    public JGetServerJSON addParam(String key, int value) {
        if (isPost)
    ...
    public JGetServerJSON addParam(String key, long value) {
        if (isPost)
            this.params = this.params + "&" + key + "=" + String.valueOf(value);
        else
            this.url = this.url + "&" + key + "=" + String.valueOf(value);
    ...
    public JGetServerJSON addParam(String key, float value) {
        if (isPost)
            this.params = this.params + "&" + key + "=" + String.valueOf(value);
        else
            this.url = this.url + "&" + key + "=" + String.valueOf(value);
    ...
    public JGetServerJSON addParamUTF8(String key, String value) {
        return addParam(key, value, "UTF-8");
    }

    public JGetServerJSON addParamUTF8(String key, int value) {
        return addParam(key, value, "UTF-8");
    }

    public JGetServerJSON addParamUTF8(String key, long value) {
        return addParam(key, value, "UTF-8");
    }

    public JGetServerJSON addParam(String key, String $value, String charSet) {
        String value = $value;
        try {
    ...
    public JGetServerJSON addParam(String key, int $value, String charSet) {
    ...
    public JGetServerJSON addParam(String key, long $value, String charSet) {
        String value = String.valueOf($value);
        try {
            value = URLEncoder.encode(value, charSet);
        } catch (Exception e) {
    ...
    public JGetServerJSON addParam(String key, float $value, String charSet) {
        String value = String.valueOf($value);
        try {
            value = URLEncoder.encode(value, charSet);
        } catch (Exception e) {
...
//        Log("dismissProgressDialog");
    ...
    public JGetServerJSON setProgressDialog(final Dialog progressDialog) {
